\section{Inference of sized types for parallel complexity}\label{ch:timeinference}
...
%
\subsection{The principal typing property}
...
%
\begin{definition}[Constraint extension]\label{def:constraintexten}
...
\begin{definition}[Principal typing]\label{def:principaltyping}
...
% \begin{definition}\label{def:typejoin}
...
%
\begin{definition}[Fresh variables]\label{def:freshfun}
...
%
% \begin{definition}\label{def:joincontext}
...
\begin{example}\label{examp:consinferr}
...
\subsection{Solving constraint satisfaction problems}\label{sec:solvcons}
